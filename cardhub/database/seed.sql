...
('Drago Cremisi', 'Fantasy Cards', 'Prima Edizione', 'Italiano', '/assets/img/uploads/DragoCremesiArtwork.png'),
('Mago delle Rune', 'Fantasy Cards', 'Set Base', 'Inglese', '/assets/img/uploads/MagoDelleRuneArtwork.png'),
('Cavaliere Antico', 'Battle Deck', 'Promo', 'Italiano', '/assets/img/CavaliereAnticoArtwork.png');
